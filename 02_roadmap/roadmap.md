...
2. v0.2 (2026-11-14): Hermes, Copilot CLI rows, forecast live line, re-prefill events,
   dev and business switch.
3. v0.3 (2026-12-12): client map, active time, export and merge, macOS and Linux builds.
4. Decision 2026-12-19.
